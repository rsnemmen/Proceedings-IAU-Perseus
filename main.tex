...
\title[Search for QPOs in the gamma-ray emission of Perseus] %% give here short title %%
...
\editors{K. Asada, E. Gouveia dal Pino, H. Nagai \& R. Nemmen, eds.}
\begin{document}
...
% \vspace*{-2.0 cm}
\begin{center}
\includegraphics[width=\linewidth]{figures/periods_ls-min_diff.png} 
% \vspace*{-1.0 cm}
